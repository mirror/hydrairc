...
#define UWM_MDICHILDHIDDEN_MSG             _T("UWM_MDICHILDHIDDEN_MSG-5DAD28E2-C961-11d5-8BDA-00500477589F")
...
struct RegisterTabbedMDIMessages
{
	RegisterTabbedMDIMessages()
	{
		...
		UWM_MDICHILDHIDDEN =             ::RegisterWindowMessage(UWM_MDICHILDHIDDEN_MSG);
	}
};
